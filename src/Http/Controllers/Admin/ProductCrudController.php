...
class ProductCrudController extends CrudController
{
    ...
    public function setup() :void
    {
        ...
        CRUD::setEntityNameStrings(
            __('eleven59.backpack-shop::product.crud.singular'),
            __('eleven59.backpack-shop::product.crud.plural')
        );
    }
    ...
    protected function setupListOperation() :void
    {
        CRUD::column('name')
            ->type('text')
            ->label(__('eleven59.backpack-shop::product.crud.name.label'));
        CRUD::column('product_category_id')
            ->type('select')
            ->label(__('eleven59.backpack-shop::product.crud.product_category_id.label'))
            ->entity('product_category')
            ->attribute('name')
            ->model(ProductCategory::class);
        CRUD::column('price')
            ->type('number')
            ->label(__('eleven59.backpack-shop::product.crud.price.label'))
        ...
        if(bpshop_show_column('product', 'sale_price')) {
            CRUD::column('sale_price')
                ->type('number')
                ->label(__('eleven59.backpack-shop::product.crud.sale_price.label'))
                ->prefix(config('backpack-shop.currency.sign', '€') . ' ')
                ->decimals(2)
                ->thousands_sep('');
        }
        CRUD::column('product_status_id')
            ->type('select')
            ->label(__('eleven59.backpack-shop::product.crud.product_status_id.label'))
    ...
    protected function setupCreateOperation() :void
    {
        ...
        CRUD::field('name')
            ->tab(__('eleven59.backpack-shop::product.crud.tabs.info'))
            ->type('text')
        ...
        CRUD::field('slug')
            ...
            ->label(__('eleven59.backpack-shop::product.crud.slug.label'))
            ->hint(__('eleven59.backpack-shop::product.crud.slug.hint'));

        if(bpshop_show_column('product', 'sku')) {
            CRUD::field('description')
                ->tab(__('eleven59.backpack-shop::product.crud.tabs.info'))
                ->type('text')
                ->label(__('eleven59.backpack-shop::product.crud.sku.label'));
        }
        ...
        if(bpshop_show_column('product', 'description')) {
            CRUD::field('description')
                ->tab(__('eleven59.backpack-shop::product.crud.tabs.info'))
                ->type('wysiwyg')
                ->label(__('eleven59.backpack-shop::product.crud.description.label'));
        }
        ...
        if(bpshop_show_column('product', 'properties')) {
            CRUD::field('properties')
                ...
                ->type('repeatable')
                ->init_rows(0)
                ->label(__('eleven59.backpack-shop::product.crud.properties.label'))
                ->subfields([
                    [
                        'name' => 'property_id',
                        'type' => 'select2_from_array',
                        'wrapper' => ['class' => 'form-group col-md-6'],
                        'label' => __('eleven59.backpack-shop::product.crud.properties.property_id.label'),
                    ...
                    [
                        ...
                        'type' => 'text',
                        'wrapper' => ['class' => 'form-group col-md-6'],
                        'label' => __('eleven59.backpack-shop::product.crud.properties.value.label'),
                    ],
                ])
                ->reorder(true)
                ->new_item_label(__('eleven59.backpack-shop::product.crud.properties.new_item_label'));
        }
        ...
        if(!empty(config('eleven59.backpack-shop.product_extras', []))) {
            foreach(config('eleven59.backpack-shop.product_extras') as $name => $extra)
            {
                ...
                $field['tab'] = $extra['tab'] ?? __('eleven59.backpack-shop::product.crud.tabs.extras');
        ...
        if(bpshop_show_column('product', 'cover')) {
            CRUD::field('cover')
                ->tab(__('eleven59.backpack-shop::product.crud.tabs.media'))
                ->type('image')
                ->label(__('eleven59.backpack-shop::product.crud.cover.label'))
        ...
        if(bpshop_show_column('product', 'photos')) {
            CRUD::field('photos')
                ...
                ->type('repeatable')
                ->init_rows(0)
                ->label(__('eleven59.backpack-shop::product.crud.photos.label'))
                ->subfields([
                    [
                        'name' => 'photo',
                        'type' => 'image',
                        'label' => __('eleven59.backpack-shop::product.crud.photos.photo.label'),
                    ...
                    [
                        'hint' => __('eleven59.backpack-shop::product.crud.photos.description.hint'),
                        'name' => 'description',
                        'type' => 'text',
                        'label' => __('eleven59.backpack-shop::product.crud.photos.description.label'),
                    ],
                ])
                ->reorder(true)
                ->new_item_label(__('eleven59.backpack-shop::product.crud.photos.new_item_label'));
        }

        CRUD::field('price')
            ->tab(__('eleven59.backpack-shop::product.crud.tabs.sales'))
            ->type('number')
            ->label(__('eleven59.backpack-shop::product.crud.price.label'))
            ->prefix(config('backpack-shop.currency.sign', '€'))
        ...
        CRUD::field('vat_class_id')
            ->tab(__('eleven59.backpack-shop::product.crud.tabs.sales'))
            ->type('select2')
            ->label(__('eleven59.backpack-shop::product.crud.vat_class_id.label'))
            ->entity('vat_class')
            ->attribute('name')
        ...
        if(bpshop_shipping_size_enabled()) {
            CRUD::field('shipping_sizes')
                ->tab(__('eleven59.backpack-shop::product.crud.tabs.shipping'))
                ->type('repeatable')
                ->init_rows(0)
                ->label(__('eleven59.backpack-shop::product.crud.shipping_sizes.label'))
                ->subfields([
                    [
                        'name' => 'shipping_size_id',
                        'type' => 'select2_from_array',
                        'wrapper' => ['class' => 'form-group col-md-6'],
                        'label' => __('eleven59.backpack-shop::product.crud.shipping_sizes.shipping_size_id.label'),
                    ...
                    [
                        ...
                        'type' => 'number',
                        'wrapper' => ['class' => 'form-group col-md-6'],
                        'label' => __('eleven59.backpack-shop::product.crud.shipping_sizes.max_product_count.label'),
                        'hint' => __('eleven59.backpack-shop::product.crud.shipping_sizes.max_product_count.hint'),
                    ],
                ])
                ->reorder(true)
                ->new_item_label(__('eleven59.backpack-shop::product.crud.shipping_sizes.new_item_label'));
        }
        ...
        if(bpshop_shipping_weight_enabled()) {
            CRUD::field('shipping_weight')
                ->tab(__('eleven59.backpack-shop::product.crud.tabs.shipping'))
                ->type('number')
                ->label(__('eleven59.backpack-shop::product.crud.shipping_weight.label'))
                ->suffix(__('eleven59.backpack-shop::product.crud.shipping_weight.suffix'));
        }
        ...
        if(bpshop_show_column('product', 'variations')) {
            $subfields = [
                [
                    'name' => 'id',
                    'type' => 'text',
                    'label' => __('eleven59.backpack-shop::product.crud.variations.id.label'),
                    'wrapper' => ['class' => 'form-group col-md-4'],
                ],
                [
                    'name' => 'description',
                    'type' => 'text',
                    'label' => __('eleven59.backpack-shop::product.crud.variations.description.label'),
                    'wrapper' => ['class' => 'form-group col-md-8'],
                ],
                [
                    'name' => 'photo',
                    'type' => 'image',
                    'label' => __('eleven59.backpack-shop::product.crud.variations.photo.label'),
                ...
                [
                    'name' => 'price',
                    'type' => 'number',
                    'label' => __('eleven59.backpack-shop::product.crud.variations.price.label'),
                    'hint' => __('eleven59.backpack-shop::product.crud.variations.price.hint'),
                    'prefix' => config('backpack-shop.currency.sign', '€'),
                    'wrapper' => ['class' => (bpshop_show_column('product', 'sale_price') ? 'form-group col-md-6' : 'form-group col-md-12')],
                    'attributes' => [
                        'step' => '0.01',
            ...
            if(bpshop_show_column('product', 'sale_price')) {
                $subfields[] = [
                    'name' => 'sale_price',
                    'type' => 'number',
                    'label' => __('eleven59.backpack-shop::product.crud.variations.sale_price.label'),
                    'prefix' => config('backpack-shop.currency.sign', '€'),
                    'wrapper' => ['class' => 'form-group col-md-6'],
                    'attributes' => [
                        'step' => '0.01',
            ...
            CRUD::field('variations')
                ->tab(__('eleven59.backpack-shop::product.crud.tabs.variations'))
                ->type('repeatable')
                ->init_rows(0)
                ->label(__('eleven59.backpack-shop::product.crud.variations.label'))
                ->subfields($subfields)
                ->reorder(true)
                ->new_item_label(__('eleven59.backpack-shop::product.crud.variations.new_item_label'));
        }
        ...
        if(bpshop_show_column('product', 'meta-title')) {
            CRUD::field('meta_title')
                ->tab('SEO/Meta')
                ->type('text')
                ->label(__('eleven59.backpack-shop::product.crud.meta-title.label'))
                ->hint(__('eleven59.backpack-shop::product.crud.meta-title.hint'));
        }
        ...
        if(bpshop_show_column('product', 'meta-description')) {
            CRUD::field('meta_description')
                ...
                ->label(__('eleven59.backpack-shop::product.crud.meta-description.label'))
                ->hint(__('eleven59.backpack-shop::product.crud.meta-description.hint'));
        }
        ...
        if(bpshop_show_column('product', 'meta-image')) {
            CRUD::field('meta_image')
                ->tab('SEO/Meta')
                ->type('image')
                ->label(__('eleven59.backpack-shop::product.crud.meta-image.label'))
                ->hint(__('eleven59.backpack-shop::product.crud.meta-image.hint'))
